...
function EditEvent({ eventId, onClose }) {
    ...
    const formik = useFormik({
        ...
        initialValues: {
            ...
            fecha: evento?.fecha || "",
            id_tipoevento: evento?.tipoEvento?.id_tipoevento || "",
        },
        ...
        onSubmit: async (values) => {
            alertaPregunta("¿Estás seguro?", "¿Deseas actualizar el evento?", async () => {
                try {
                    alertaCargando("Actualizando evento...", "Espere un momento");
                    ...
                    await AxiosClient.put(`/evento/${eventId}`, formData);

                    if (imagen) {
                        const formImage = new FormData();
                        formImage.append("imagen", imagen);

                        await AxiosFormClient.post(`/evento/${eventId}/upload-image`, formImage);
                    }
                    ...
                    <div className="px-6 py-4">
                        ...
                        <form onSubmit={formik.handleSubmit} className="space-y-2">
                            ...
                            <div className="relative mb-2">
                                ...
                                {evento?.imagen && (
                                    <img
                                        src={`http://localhost:8080/api/evento/path/${evento.imagen}`}
